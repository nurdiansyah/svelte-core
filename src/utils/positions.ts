...
const getMainPosition = (position, { top, bottom, left, right, height, width, clientWidth, clientHeight }) => {
...
const getSecondaryPosition = (position, { top, bottom, left, right, height, width, clientWidth, clientHeight }) => {
